"""
UMAP visualization of gait embeddings colored by activity type.
Loads pre-computed UMAP coordinates from results/umap_embeddings.csv.
"""
import os
import pandas as pd
...
CLASSIFICATION_AUC = {
    ...
    'self_selected_gait_speed': 0.9619,
    'sit_to_stand': 1.0000,
    'stationary_walk': 0.9999,
    'tm_3kmh': 0.9652,
}
