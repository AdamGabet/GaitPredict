"""
Plot ROC curves for gender prediction across all activities.
Data loaded from pre-computed roc_gender.csv in results/.
"""
...
def main():
    ...
    for activity in auc_vals.index:
        act_df = df[df['activity'] == activity].sort_values('fpr')
