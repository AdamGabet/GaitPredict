"""Extended Figure 4: Normalized keypoints vs GaitMAE absolute Pearson r gain.
...
def plot_absolute_gain(seed_table, compact_table):
    ...
    axes[0].set_ylabel("Predictive Power (Pearson r)", fontsize=15, labelpad=8)
...
def main():
    ...
    set_final_style()
    plot_absolute_gain(seed_table, compact_table)
